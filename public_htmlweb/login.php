...
<br><br>
  ...
  <button class="btn btn-primary" type="button" onMousedown="mostrarContrasena()" onMouseup="ocultarContrasena()" onMouseout="ocultar()">👁</button>
...
<br>
    ...
    <br><br>
    <div class="g-recaptcha" data-sitekey="6LcMnvcaAAAAAKbqSKpWlfF48AqE1izgQuTPJr4i"></div>
...
<script type="text/javascript">
  ...
  $('#registrarNuevo').click(function(){
      ...
      if($('#correo').val()==""){
        ...
        return false;
      }else if(!(crr.match(/\S+@\S+\.\S+/))){
        alertify.alert("Tu correo debe tener la forma ejemplo@ejemplo.com");
        return false;
