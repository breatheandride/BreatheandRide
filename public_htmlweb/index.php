...
<body data-spy="scroll" data-target="#navbar-example">
  ...
  <header>
    ...
    <!-- header-area end -->
    <style>img[alt="www.000webhostt.com"]{display:none;}</style>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content">
                ...
                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                  <h1 class="title2">Nos encargamos de que sepas la calidad<br> del aire que estás respirando</h1>
                </div>
                <!-- layer 3 -->
                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                  <a class="ready-btn right-btn page-scroll" href="#about">Saber Más</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content text-center">
                ...
                <div class="layer-1-1 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                  <h2 class="title1">Los mejores cuidándote </h2>
                </div>
                <!-- layer 2 -->
                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content">
                ...
                <!-- layer 3 -->
                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                  <a class="ready-btn right-btn page-scroll" href="#blog">Leer más</a>
                  </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="well-middle">
            <div class="single-well">
              ...
              <p>
                En Breathe and ride buscamos darte acompañamiento a ti como ciclista en tus rutas diarias, ayudandote a concientizar sobre el aire que respiras con ayuda de diferentes sensores y actuadores, todos estos integrados en una cajita que cabe en tu mano.<br><br> Entre nuestras principales caracteristicas te ofrecemos:
              </p>
              <ul>
                <li>
                  <i class="fa fa-check"></i> Innovación
                </li>
                <li>
            ...
            <div class="about-move">
              <div class="services-details">
                <div class="single-services">
                  ...
                  <p>
                    El sistema cuenta con un módulo GPS para brindar información completa del nivel de contaminación de la ruta recorrida.
                  </p>
                </div>
              </div>
              <!-- end about-details -->
            ...
            <div class="about-move">
              <div class="services-details">
                <div class="single-services">
                  ...
                  <p>
                    En el perfil de cada usuario se puede acceder a los datos de contaminación de todos sus recorridos junto con estadísticas descriptivas.
                  </p>
                </div>
              </div>
              <!-- end about-details -->
            ...
            <div class=" about-move">
              <div class="services-details">
                <div class="single-services">
                  ...
                  <p>
                   En la pantalla OLED de la bicicleta se mostrará una alerta visual si el aire que está respirando el ciclista es peligroso para su salud.
                  </p>
                </div>
              </div>
              <!-- end about-details -->
            ...
            <div class=" about-move">
              <div class="services-details">
                <div class="single-services">
                  ...
                  <p>
                    Con los datos adquiridos se hace una predicción de la contaminación diaria para que el usuario pueda determinar mejor su ruta.
                  </p>
                </div>
              </div>
              <!-- end about-details -->
            ...
            <div class=" about-move">
              <div class="services-details">
                <div class="single-services">
                  ...
                  <h4>Red de datos</h4>
                  <p>
                    Cada usuario podrá ver un mapa de su locación con los niveles de contaminación.
                  </p>
                </div>
              </div>
              <!-- end about-details -->
            ...
            <div class="panel-group" id="accordion">
                ...
                <div class="panel-heading">
                  <h4 class="check-title">
											<a data-toggle="collapse" class="active" data-parent="#accordion" href="#check1">
                                                <span class="acc-icons"></span>¿Cómo funciona la conexión a internet?
											</a>
										</h4>
                </div>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="check-title">
											<a data-toggle="collapse" data-parent="#accordion" href="#check2">
                                                <span class="acc-icons"></span>  ¿Que fuente de alimentación usa?
											</a>
										</h4>
                </div>
                <div id="check2" class="panel-collapse collapse">
                  <div class="panel-body">
                    <p>
                       La alimentación del sistema se realiza mediante una bateria externa, esta es la que deberás cargar cuando el sistema no tenga más energía.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="check-title">
											<a data-toggle="collapse" data-parent="#accordion" href="#check3">
                                                <span class="acc-icons"></span>¿Para qué sirve la pantalla?
											</a>
										</h4>
                </div>
                <div id="check3" class="panel-collapse collapse ">
                  <div class="panel-body">
                    <p>
                      La pantalla te mostrará la calidad del aire que estás respirando durante la rodada. Si la calidad es muy mala y es peligroso para tu salud, entonces el sistema te mostrará una alerta.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="check-title">
											<a data-toggle="collapse" data-parent="#accordion" href="#check4">
                                                <span class="acc-icons"></span>¿Para qué sirve la página web?
											</a>
										</h4>
                </div>
                <div id="check4" class="panel-collapse collapse">
                  <div class="panel-body">
                    <p>
                      Al crear tu cuenta en <a href ="login.php">Breathe and Ride</a>, tienes acceso a un histórico de los datos de la calidad del aire durante tus recorridos y además una predicción de la misma.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="tab-menu">
            ...
            <ul class="nav nav-tabs" role="tablist">
              ...
              <li>
                <a href="#p-view-2" role="tab" data-toggle="tab">¿Por qué Breathe & Ride?</a>
              </li>
            ...
            <div class="tab-pane active" id="p-view-1">
              <div class="tab-inner">
                <div class="event-content head-team">
                  <h4>Proyecto</h4>
                  <p>
                   Con el fin de que el ciclista obtenga información sobre el aire que respira y los potenciales riesgos para su salud al atravesar ciertas zonas de las ciudades, se propone el proyecto Breathe and Ride.<br><br> El sistema consiste, en primer lugar, en dos sensores para la calidad del aire: el MQ9 que es un sensor de monóxido de carbono y gases inflamables, y el sensor MQ135 que mide benceno, alcohol, humo, entre otros gases; luego de obtener los datos por medio de los sensores, el sistema gracias a un módulo GPS, permite procesar y subir la información a la nube, indicando el lugar y los niveles de contaminación en el aire para las respectivas zonas. Esta información es mostrada también en una pantalla Oled, todo esto en tiempo real.<br><br> El usuario puede acceder a una página web donde se mostrará tanto su información individual, como las alertas y estadísticas de todos los usuarios del sistema.
                  </p>
  ...
  <div class="reviews-area hidden-xs">
    <div class="work-us">
      ...
      <div class="work-right-text text-center">
        ...
        <h5>Ayúdanos a monitorear el aire<br> que respiramos, obten predicciones basadas en tus datos<br> y alertas en tiempo real.</h5>
        <a href="https://www.mercadolibre.com.co/"  target="_blank" class="ready-btn">¡ Cómpralo ya !</a>
      </div>
    </div>
  </div>
  <!-- End reviews Area -->
...
<!-- Start Testimonials -->
              ...
              <div class="testimonial-carousel">
                <div class="single-testi">
                  <div class="testi-text">
                    <p>
                      Nuestro vínculo común más básico es que todos vivimos en este planeta. <br> Todos respiramos el mismo aire. A todos nos preocupa el futuro de nuestros hijos. Y todos somos mortales.
                    </p>
                ...
                <div class="single-testi">
                  <div class="testi-text">
                    <p>
                       Respirar en Bogotá equivalía a fumar en promedio 1,3 cigarrillos diarios.
                    </p>
                ...
                <div class="single-testi">
                  <div class="testi-text">
                    <p>
                      El hombre de hoy usa y abusa de la naturaleza, como si hubiera de ser el último inquilino<br> de este desgraciado planeta, como si detrás de él no se anunciara un futuro.
                    </p>
                ...
                <!-- End single item -->
                  ...
                  <div class="testi-text">
                    <p>
                      El hombre es dueño de su destino y su destino es la tierra<br> y él mismo la está destruyendo hasta quedarse sin destino.
                    </p>
                    <h6>Frida Kahlo</h6>
                  </div>
                </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="single-blog">
              ...
              <div class="blog-text">
                <h4>
                                        <a href="https://www.eltiempo.com/bogota/afectacion-de-la-contaminacion-del-aire-para-los-ciclistas-472238" target="_blank">Así afecta la contaminación del aire en Bogotá a los ciclistas</a>
									</h4>
                <p>
                  Los ciclistas son efectivamente quienes más se exponen al tráfico, el esmog y la polución, por lo que el intercambio con partículas nocivas es mayor, en especial cuando se recorren largos trayectos.
</p>

              </div>
              <span>
									<a href="https://www.eltiempo.com/bogota/afectacion-de-la-contaminacion-del-aire-para-los-ciclistas-472238" target="_blank" class="ready-btn">Leer más</a>
								</span>
            </div>
            <!-- Start single blog -->
          </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="single-blog">
              ...
              <div class="blog-text">
                <h4>
                                        <a href="https://agenciadenoticias.unal.edu.co/detalle/article/ciclistas-los-mas-expuestos-a-la-contaminacion-en-bogota.html" target="_blank">Ciclistas, los más expuestos a la contaminación en Bogotá</a>
									</h4>
                <p>
                  Los ciclistas son los más afectados por las concentraciones de partículas ultrafinas en el ambiente, dado que requieren un mayor esfuerzo físico y, por ende, una tasa de inhalación más alta.
                </p>
              </div>
              <span>
									<a href="https://agenciadenoticias.unal.edu.co/detalle/article/ciclistas-los-mas-expuestos-a-la-contaminacion-en-bogota.html" target="_blank" class="ready-btn">Leer más</a>
								</span>
            </div>
            <!-- Start single blog -->
          </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="single-blog">
              ...
              <div class="blog-text">
                <h4>
                                        <a href="https://caracol.com.co/emisora/2017/06/15/bogota/1497561972_587611.html" target="_blank">Ciclistas, los más afectados por la contaminación del aire</a>
									</h4>
                <p>
                  Debido a exposición de partículas contaminantes en el aire, los expertos recomiendan utilizar máscaras o tapabocas antipolución, mientras se adelantan políticas para disminuir la contaminación en el aire.
                </p>
              </div>
              <span>
									<a href="https://caracol.com.co/emisora/2017/06/15/bogota/1497561972_587611.html" target="_blank" class="ready-btn">Leer Más</a>
								</span>
            </div>
          </div>
          <!-- End Right Blog-->
  ...
  <!-- End Blog -->
        ...
        <div class="section-headline text-center">
               <h2>Emisiones de CO2 de los vehículos</h2>
            </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="contact-icon text-center">
              <div class="single-icon">
                ...
                <p>
                  Call: <a href="tel:+57 313 4860036">+57 313 4860036</a></a><br>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="form contact-form">
              ...
              <form action="enviar.php" method="POST" role="form" class="contactForm">
                ...
                <div class="form-group">
                  <input type="email" class="form-control" name="email" id="email" placeholder="Tu correo" data-rule="email" data-msg="Ingrese una dirección de correo electrónico válida" />
                  <div class="validation"></div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <textarea class="form-control" name="message" id="message" rows="5" data-rule="required" data-msg="Escribe algo para nosotros" placeholder="Mensaje"></textarea>
                  <div class="validation"></div>
                </div>
            ...
            <div class="footer-content">
              <div class="footer-head">
                ...
                <div class="footer-contacts">
                  <p><span>Tel:</span> <a href="tel:+57 322 460 6847">+57 322 460 6847</a><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="tel:+57 323 206 7189">+57 323 206 7189</a></p>
