          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="form contact-form">
              ...
              <form action="enviar.php" method="POST" role="form" class="contactForm">
                ...
                <div class="form-group">
                  <input type="email" class="form-control" name="email" id="email" placeholder="Tu correo" data-rule="email" data-msg="Introduzca una dirección de correo electrónico válida" />
                  <div class="validation"></div>
                </div>
                <div class="form-group">
