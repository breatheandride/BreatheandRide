            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content">
                ...
                <div class="layer-1-1 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                  <h2 class="title1">Que tu mayor preocupación sea llegar más lejos </h2>
                </div>
                <!-- layer 2 -->
            ...
            <div class="single-blog-page">
              <div class="left-blog">
                ...
                <ul>
                  ...
                  <li>
                    <a href="blog-details.php">Procesamiento y comunicación</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="single-blog">
                ...
                <h3><p aling="justify">
                    ¡Hola Brider! Aquí encontrarás tus datos en tiempo real. Podrás monitorear la calidad del aire que estás respirando, podrás ver tu localización y además un promedio por minuto.</p>
  ...
  <div class="reviews-area hidden-xs">
    <div class="work-us">
      ...
      <div class="work-right-text text-center">
        <h2>Recuerda</h2>
        <h5>El dispositivo cuenta con una pantalla OLED, la cual te alertará cuando la calidad del aire que estés respirando sea peligrosa para tu salud.</h5>
...
<div class="col-md-100 col-sm-12 col-xs-12">
  <div class="reviews-area hidden-xs">
    <div class="work-us">
      ...
      <div class="work-right-text text-center">
        <h2>Recuerda</h2>
        <h5>Si se supera el mínimo umbral para riesgo a tu salud, se envía un mensaje de alerta a Telegram con tu geolocalización en el punto de riesgo..</h5>
